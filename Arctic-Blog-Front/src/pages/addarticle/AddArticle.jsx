...
import {  BackTop, Button, Col, Input, Row } from "antd";
...
import { getUploadToken, UploadImg } from "../../api/upload";
...
function AddArticle() {
  ...
  const addArticle = () => {
    getUploadToken()
      .then((res1) => {
        localStorage.setItem("Access_Token", res1.data.data);
        UploadImg(image)
          .then((res2) => {
            console.log(res2);
